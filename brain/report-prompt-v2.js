...
function buildReportPromptV2(params) {
  ...
  return [
    ...
    `2. diligence_flags (1-5): Each gets a severity (concern/watch_item/strength), evidence, and a`,
    `   founder_question. The question must be SPECIFIC TO THIS APP and ANSWERABLE ONLY because`,
    `   the reader saw this evidence. No generic mobile-UX questions.`,
